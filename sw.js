const CACHE_NAME = "anatomyquest3d-mobile-v20";
const APP_SHELL_FILES = [
  ...
  "./favicon.ico",
  "./styles.css",
  "./styles.css?v=20260718-1",
  "./app.js",
  "./app.js?v=20260718-1",
  "./quizdata.json",
  "./content/structures.json",
  "./content/v2/runtime-index.json",
  "./content/v2/sources.json",
  "./docs/content-source-attribution.md",
  "./manifest.json",
  ...
  "./src/engine/cameraController.js?v=20260718-1",
  "./src/engine/meshPicking.js",
  "./src/engine/meshPicking.js?v=20260718-1",
  "./src/game/modes.js",
  ...
  "./src/ui/onboarding.js?v=20260718-1",
  "./src/ui/exploreSearch.js",
  "./src/ui/exploreSearch.js?v=20260715-1",
  "./src/ui/exploreContent.js",
  "./src/ui/exploreContent.js?v=20260715-3",
  "./src/ui/exploreTerminology.js",
  "./src/ui/exploreTerminology.js?v=20260715-3",
  "./src/anatomy/learningStatus.js",
  "./src/anatomy/learningStatus.js?v=20260715-1",
  "./src/anatomy/publicationBlocks.js",
  "./src/anatomy/publicationBlocks.js?v=20260715-1",
